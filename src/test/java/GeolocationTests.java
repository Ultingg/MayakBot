...
//        location.setLongitude(30.484284);
//        location.setLatitude(59.903431 );
//
//        Geolocation expected = new Geolocation();
//        expected.setFullName("MoscowRailwaySt");
//        expected.setLongitude(30.362520);
//        expected.setLatitude(59.930102);
//        expected.setDistance(7408.5594135421225);
//
//
//        Geolocation actual = mayakBot.getNearestLocation(location);
//
